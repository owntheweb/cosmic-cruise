 ...
 */
 ...
 //Modified by Christopher Stevens to specify eyeSeparation and focalLength as arguments
 //Also removed clear features for layering, for now
THREE.StereoEffect = function ( renderer, eyeSeparation, focalLength ) {
	...
	this.focalLength = focalLength; 	// Distance to the non-parallax or projection plane
	...
	this.render = function ( scene, camera ) {
		...
		//renderer.clear(); //removed autoclear
